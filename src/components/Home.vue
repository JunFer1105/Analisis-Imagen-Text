<template>
  <v-container>
    ...
    <v-row>
      <v-flex xs12 pb-3>
        <v-btn color="teal lighten-4" @click="uploadFile">Enviar</v-btn>
      </v-flex>
    </v-row>
    <v-divider></v-divider>
    <v-layout row wrap align-center>
      <v-flex xs12>
        <v-conteiner fluid class="pl-0 pr-0">
          <v-layout row wrap>
              ...
              <v-card>
                ...
                <v-card-title>
                  <div style="height: 100px;">
                    ...
                    <v-chip> {{image.scorePromedio | trimScore}} </v-chip>
                    <br>
...
import axios from 'axios'
  export default {
    ...
    data: () => ({
      apiKey: 'AIzaSyAhlQqTzQ55-hXU43lFXxUhvl8NFWAJW_g',
      file: '',
      images: []
    }),
    methods:{
    ...
    uploadFile: function(){
      ...
      let metadata = { contentTyoe: this.file.type }
